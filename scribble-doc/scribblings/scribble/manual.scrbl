...
@tech{element transformers}. Otherwise, identifiers normally typeset
the same way that they print, but when an identifier has a
@racket['display-string] syntax property, the syntax property can
supply a string to display for the identifier, instead.
