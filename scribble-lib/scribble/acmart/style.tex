...
\renewcommand{\SAuthorAffiliation}[1]{\affiliation{#1}}
\renewcommand{\SAuthorAdditionalAffiliation}[1]{\additionalaffiliation{#1}}
\renewcommand{\SAuthorEmail}[1]{\email{#1}}
\renewcommand{\SAuthorNoteMark}[1]{\authornotemark[#1]}
