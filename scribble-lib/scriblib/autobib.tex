...
% Wrapper around `\hyperref` to swap the order of arguments,
%  because Scribble's `command-extras` puts extra arguments after the text to render.
\newcommand{\Autobibhyperref}[2]{\hyperref[#2]{#1}}
